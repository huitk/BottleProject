...
public class driverBottle {
	public static void main(String[] args) {
		...
		bottle1.read();
		System.out.println("Bottle1 is this value " + bottle1.getCookies() + ".");
		System.out.println("Please enter a number for bottle2:");
		bottle2.read();
		bottle3 = bottle2.add(bottle1);
		
		bottle4 = bottle3.divide(2);
		System.out.println("The 2 bottle average is: " + bottle4.getCookies() + ".");
		System.out.print("Subtracting bottle1 from bottle2 is: " );
		bottle3 = bottle2.subtract(bottle1);
		System.out.println( bottle3.getCookies());
		bottle3 = bottle2.divide(bottle1);
		System.out.println("Dividing bottle2 with bottle1 is: " + bottle3.getCookies() + ".");
		...
		bottle4.set(10);
		System.out.println("The value of bottle4 is " + bottle4.getCookies() + ".");
		System.out.println("Bottle4 is now multipled with bottle1.  The value is placed in " +
				"bottle5.");
		bottle5 = bottle1.multiply(bottle4);
		System.out.println("The value of bottle5 is " + bottle5.getCookies() + ".");
		...
		System.out.println("Adding your number " + x +
			" to bottle1 gives a new Bottle with " + bottle3.getCookies() + " in it.");
		System.out.print("Adding the number " + bottle2.getCookies() + " which is the number" +
				" in bottle2 to the\nnumber in ");
		bottle2 = bottle1.add(bottle2);
		System.out.println("bottle1 which is " + bottle1.getCookies() +" gives " + bottle2.getCookies() + ".");
		bottle2.set(bottle2.getCookies());
	}
